...
const containerVariants = cva('shrink-0 flex-row items-center justify-center active:translate-y-px', {
  variants: {
    variant: {
      ...
      outline: 'border border-primary-500 bg-neutral-25 active:bg-primary-50',
      brandOutline: 'border-[0.7px] border-neutral-300 bg-transparent active:bg-neutral-75',
      secondary: 'border border-transparent bg-neutral-50 active:bg-neutral-100',
      ...
      neutral: 'border border-neutral-500 bg-neutral-25 active:bg-neutral-75',
    },
    size: {
  ...
  compoundVariants: [
    { variant: ['default', 'gradient', 'destructive', 'success', 'warning', 'danger', 'info'], disabled: true, className: 'bg-neutral-100' },
    { variant: ['outline', 'brandOutline', 'neutral'], disabled: true, className: 'border-neutral-200' },
    { variant: 'secondary', disabled: true, className: 'bg-neutral-50' },
  ],
...
const buttonTextVariants = cva('font-medium', {
  variants: {
    variant: {
      ...
      brandOutline: 'text-neutral-975',
      secondary: 'text-neutral-975',
    ...
    pressed: { true: '', false: '' },
    disabled: { true: 'text-neutral-900', false: '' },
  },
