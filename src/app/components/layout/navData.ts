...
export const navigation: NavSection[] = [
  {
    section: 'Overview',
    items: [
      { label: 'Get Started',  path: '/',             description: 'What Breathe is and how to start using it' },
      { label: 'Installation', path: '/installation', description: 'Install @aumraa/breathe-react in your product' },
    ],
  },
  {
    section: 'Foundations',
  ...
  },
  {
    section: 'Atoms',
    items: [
      { label: 'Amount Visibility Toggle', badge: 'Kaayo', path: '/atoms/amount-visibility-toggle', description: 'Financial privacy toggle component' },
      ...
      { label: 'Button',      path: '/atoms/button',      description: 'Action triggers' },
      {
        ...
        items: [
          ...
          { label: 'Chip Multi-Select', badge: 'Kaayo', path: '/atoms/form-elements/chip-multi-select', description: 'Multi-tag pill filter' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Bottom Nav', badge: 'Kaayo',          path: '/molecules/bottom-nav',          description: 'Fixed 5-tab mobile and tablet navigation bar' },
      ...
      { label: 'Delete Guard Sheet', badge: 'Kaayo', path: '/molecules/delete-guard-sheet', description: 'Safety confirmation modal' },
      { label: 'Dropdown Menu',      path: '/molecules/dropdown-menu',      description: 'Contextual action menus' },
      { label: 'Empty State', badge: 'Kaayo',        path: '/molecules/empty-state',        description: 'Empty data container' },
      { label: 'Form',               path: '/molecules/form',               description: 'Input collection patterns' },
      { label: 'Header', badge: 'Kaayo',             path: '/molecules/header',             description: 'App top bar with logo, bell and user chip' },
      ...
      { label: 'Photo Viewer', badge: 'Kaayo',       path: '/molecules/photo-viewer',       description: 'Full screen image lightbox' },
      ...
      { label: 'Step Indicator', badge: 'Kaayo',     path: '/molecules/step-indicator',     description: 'Progress tracker bar' },
      ...
      { label: 'WhatsApp Controls', badge: 'Kaayo',  path: '/molecules/whatsapp-controls',  description: 'WhatsApp reminder trigger' },
    ],
  },
  {
    section: 'Organisms',
    items: [
      ...
      { label: 'Menu Layouts', badge: 'Kaayo',     path: '/organisms/menu-layouts',     description: 'Interactive Kaayo app layouts in an Android device mockup' },
      { label: 'Navigation Menu', badge: 'Kaayo',  path: '/organisms/navigation-menu',  description: 'Horizontal nav with dropdowns' },
  ...
  {
    section: 'Technocracy OS',
    items: [
      { label: 'Dark Dashboard', path: '/technocracy', description: 'Permanent Dark Mode Admin Dashboard System' },
    ],
  },
]
