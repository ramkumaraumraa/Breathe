...
export const navigation: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Bottom Nav',          path: '/molecules/bottom-nav',          description: 'Fixed 5-tab mobile and tablet navigation bar' },
      ...
      { label: 'Header',             path: '/molecules/header',             description: 'App top bar with logo, bell and user chip' },
