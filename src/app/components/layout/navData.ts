...
export const navigation: NavSection[] = [
  ...
  },
  {
    section: 'Atoms',
    items: [
      { label: 'Amount Visibility Toggle', path: '/atoms/amount-visibility-toggle', description: 'Financial privacy toggle component' },
      ...
      { label: 'Button',      path: '/atoms/button',      description: 'Action triggers' },
      {
        ...
        items: [
          ...
          { label: 'Chip Multi-Select', path: '/atoms/form-elements/chip-multi-select', description: 'Multi-tag pill filter' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Delete Guard Sheet', path: '/molecules/delete-guard-sheet', description: 'Safety confirmation modal' },
      { label: 'Dropdown Menu',      path: '/molecules/dropdown-menu',      description: 'Contextual action menus' },
      { label: 'Empty State',        path: '/molecules/empty-state',        description: 'Empty data container' },
      ...
      { label: 'Photo Viewer',       path: '/molecules/photo-viewer',       description: 'Full screen image lightbox' },
      ...
      { label: 'Step Indicator',     path: '/molecules/step-indicator',     description: 'Progress tracker bar' },
      ...
      { label: 'WhatsApp Controls',  path: '/molecules/whatsapp-controls',  description: 'WhatsApp reminder trigger' },
    ],
  },
  {
    section: 'Organisms',
    items: [
      ...
      { label: 'Menu Layouts',     path: '/organisms/menu-layouts',     description: 'Interactive Kaayo app layouts in an Android device mockup' },
