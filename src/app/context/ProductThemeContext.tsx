...
export const productMeta: Record<ProductId, {
  ...
  technocracy: {
    ...
    vars: {
      ...
      '--accent':                   'var(--thcy-color-accent)',
      '--accent-foreground':        'var(--thcy-color-accent-foreground)',
      ...
      '--destructive':              'var(--thcy-color-danger)',
      '--destructive-foreground':   'var(--color-neutral-white)',
    },
  },
  maligai: {
    ...
    vars: {
      ...
      '--accent':                   'var(--mlgm-color-accent)',
      '--accent-foreground':        'var(--mlgm-color-accent-foreground)',
      ...
      '--destructive':              'var(--mlgm-color-danger)',
      '--destructive-foreground':   'var(--color-neutral-white)',
    },
  },
  ulagellam: {
  ...
  ilakh: {
    ...
    vars: {
      ...
      '--accent':                   'var(--ilkh-color-accent)',
      '--accent-foreground':        'var(--ilkh-color-accent-foreground)',
      ...
      '--destructive':              'var(--ilkh-color-danger)',
      '--destructive-foreground':   'var(--color-neutral-white)',
    },
  },
  yakaizen: {
