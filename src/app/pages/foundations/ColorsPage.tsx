...
const brandPalettes: BrandPalette[] = [
  {
    ...
    core: [
      ...
      },
      {
        ...
        stops: [
          ...
          { stop: 50, hex: '#FCE7D5', textColor: '#0F172A' },
          { stop: 75, hex: '#FAD8BA', textColor: '#0F172A' },
          { stop: 100, hex: '#F8CDA7', textColor: '#0F172A' },
          { stop: 200, hex: '#F5B880', textColor: '#0F172A' },
          { stop: 300, hex: '#F2A45C', textColor: '#0F172A' },
          { stop: 400, hex: '#F0923B', textColor: '#0F172A' },
          { stop: 500, hex: '#ED811C', textColor: '#0F172A' },
          { stop: 600, hex: '#CB711C', textColor: '#0F172A' },
          { stop: 700, hex: '#A9601D', textColor: '#fff' },
          { stop: 800, hex: '#8A4F1A', textColor: '#fff' },
          { stop: 900, hex: '#6C3E17', textColor: '#fff' },
          { stop: 925, hex: '#553114', textColor: '#fff' },
          { stop: 950, hex: '#4C2C13', textColor: '#fff' },
    ...
    gradients: [
      ...
      { name: 'Energy', token: 'gradient.energy', stops: 'secondary.500 → tertiary.500', usage: 'Promotional banners, feature callouts', gradient: 'linear-gradient(135deg, #40AAD4 0%, #ED811C 100%)' },
      { name: 'Arc', token: 'gradient.arc', stops: 'tertiary.500 → primary.500', usage: 'Illustrations, decorative brand moments', gradient: 'linear-gradient(135deg, #ED811C 0%, #1C60C1 100%)' },
      ...
      { name: 'Full Spectrum', token: 'gradient.full-spectrum', stops: 'tertiary.500 → primary.500 → secondary.500', usage: 'Brand-only — splash screens, launch assets', gradient: 'linear-gradient(135deg, #ED811C 0%, #1C60C1 50%, #40AAD4 100%)' },
    ],
  },
  {
    id: 'aumraa',
    ...
    core: [
      {
        name: 'Primary',
        description: 'Forest Green — brand identity, taken from the logo mark. Stability and long-term thinking.',
        root: '#2F9E44',
        stops: [
          ...
          { stop: 500, hex: '#2F9E44', textColor: '#0F172A' },
        ...
        tokenPath: 'color.green',
        cssPrefix: '--color-green',
        keyStops: [500, 100, 700],
      },
      {
        name: 'Secondary',
        description: 'Yellow-Green — energy, momentum, optimism. The second half of the logo gradient.',
        root: '#CFCF2A',
        stops: [
          ...
          { stop: 600, hex: '#B4B424', textColor: '#0F172A' },
          { stop: 700, hex: '#98981E', textColor: '#0F172A' },
        ...
        tokenPath: 'color.yellowGreen',
        cssPrefix: '--color-yellow-green',
        keyStops: [500, 200, 600],
      },
      {
        name: 'Supportive',
        description: 'Supportive Blue — informational surfaces, links and secondary guidance. Part of the feedback family, not the Aumraa brand palette.',
        root: '#266FDC',
        stops: [
          { stop: 25, hex: '#E5EEFB', textColor: '#0F172A' },
          { stop: 50, hex: '#D4E2F8', textColor: '#0F172A' },
          { stop: 75, hex: '#C2D7F5', textColor: '#0F172A' },
          { stop: 100, hex: '#B1CBF2', textColor: '#0F172A' },
          { stop: 200, hex: '#8EB4ED', textColor: '#0F172A' },
          { stop: 300, hex: '#6B9DE7', textColor: '#0F172A' },
          { stop: 400, hex: '#4986E2', textColor: '#0F172A' },
          { stop: 500, hex: '#266FDC', textColor: '#fff' },
          { stop: 600, hex: '#2461BE', textColor: '#fff' },
          { stop: 700, hex: '#2254A0', textColor: '#fff' },
          { stop: 800, hex: '#204781', textColor: '#fff' },
          { stop: 900, hex: '#1E3963', textColor: '#fff' },
          { stop: 925, hex: '#1D3254', textColor: '#fff' },
          { stop: 950, hex: '#1C2C45', textColor: '#fff' },
          { stop: 975, hex: '#1B2536', textColor: '#fff' },
        ],
        tokenPath: 'color.feedback.supportive',
        cssPrefix: '--color-feedback-supportive',
        keyStops: [500, 100, 700],
      },
    ],
    gradients: [
      ...
      { name: 'Momentum', token: 'gradient.momentum', stops: 'primary.500 → supportive.500', usage: 'Feature callouts, CTAs', gradient: 'linear-gradient(135deg, #2F9E44 0%, #266FDC 100%)' },
      { name: 'Clarity', token: 'gradient.clarity', stops: 'secondary.500 → supportive.500', usage: 'Service cards, portfolio highlights', gradient: 'linear-gradient(135deg, #CFCF2A 0%, #266FDC 100%)' },
  ...
  },
  {
    ...
    core: [
      {
        name: 'Primary',
        description: 'Pine Green — Brand identity, drawn straight from the logo mark. Drives primary actions, headers and body text.',
        root: '#183C38',
        stops: [
          { stop: 25, hex: '#F1F3F3', textColor: '#0F172A' },
          { stop: 50, hex: '#E3E8E7', textColor: '#0F172A' },
          { stop: 75, hex: '#D5DCDB', textColor: '#0F172A' },
          { stop: 100, hex: '#C3CCCB', textColor: '#0F172A' },
          { stop: 200, hex: '#A3B1AF', textColor: '#0F172A' },
          { stop: 300, hex: '#798E8C', textColor: '#0F172A' },
          { stop: 400, hex: '#4B6764', textColor: '#fff' },
          { stop: 500, hex: '#183C38', textColor: '#fff' },
          { stop: 600, hex: '#163632', textColor: '#fff' },
          { stop: 700, hex: '#132F2C', textColor: '#fff' },
          { stop: 800, hex: '#0F2624', textColor: '#fff' },
          { stop: 900, hex: '#0C1E1C', textColor: '#fff' },
          { stop: 925, hex: '#0A1816', textColor: '#fff' },
          { stop: 950, hex: '#071110', textColor: '#fff' },
          { stop: 975, hex: '#040A09', textColor: '#fff' },
        ],
        tokenPath: 'color.pine',
        cssPrefix: '--color-pine',
        keyStops: [500, 100, 700],
      },
      {
        name: 'Secondary',
        description: 'Brand Gold — Accent and highlight. Offers, price emphasis and category markers.',
        root: '#BB893A',
        stops: [
          { stop: 25, hex: '#FBF8F3', textColor: '#0F172A' },
          { stop: 50, hex: '#F7F1E7', textColor: '#0F172A' },
          { stop: 75, hex: '#F3EADC', textColor: '#0F172A' },
          { stop: 100, hex: '#EDE0CC', textColor: '#0F172A' },
          { stop: 200, hex: '#E4D0B0', textColor: '#0F172A' },
          { stop: 300, hex: '#D8BB8D', textColor: '#0F172A' },
          { stop: 400, hex: '#CAA365', textColor: '#0F172A' },
          { stop: 500, hex: '#BB893A', textColor: '#0F172A' },
          { stop: 600, hex: '#A87B34', textColor: '#0F172A' },
          { stop: 700, hex: '#926B2D', textColor: '#fff' },
          { stop: 800, hex: '#785825', textColor: '#fff' },
          { stop: 900, hex: '#5E451D', textColor: '#fff' },
          { stop: 925, hex: '#4B3717', textColor: '#fff' },
          { stop: 950, hex: '#342610', textColor: '#fff' },
          { stop: 975, hex: '#1E1609', textColor: '#fff' },
        ],
        tokenPath: 'color.gold',
        cssPrefix: '--color-gold',
        keyStops: [500, 200, 700],
      },
      {
        name: 'Tertiary',
        description: 'Earth Brown — Grounding tone for produce, packaging and illustrative surfaces.',
        root: '#845E41',
        stops: [
          { stop: 25, hex: '#F8F5F4', textColor: '#0F172A' },
          { stop: 50, hex: '#F0ECE8', textColor: '#0F172A' },
          { stop: 75, hex: '#E9E2DD', textColor: '#0F172A' },
          { stop: 100, hex: '#DFD5CE', textColor: '#0F172A' },
          { stop: 200, hex: '#CEBFB3', textColor: '#0F172A' },
          { stop: 300, hex: '#B8A291', textColor: '#0F172A' },
          { stop: 400, hex: '#9F816B', textColor: '#0F172A' },
          { stop: 500, hex: '#845E41', textColor: '#fff' },
          { stop: 600, hex: '#77553B', textColor: '#fff' },
          { stop: 700, hex: '#674933', textColor: '#fff' },
          { stop: 800, hex: '#543C2A', textColor: '#fff' },
          { stop: 900, hex: '#422F21', textColor: '#fff' },
          { stop: 925, hex: '#35261A', textColor: '#fff' },
          { stop: 950, hex: '#251A12', textColor: '#fff' },
          { stop: 975, hex: '#150F0A', textColor: '#fff' },
        ],
        tokenPath: 'color.earth',
        cssPrefix: '--color-earth',
        keyStops: [500, 100, 700],
      },
    ],
    gradients: [
  ...
  },
  {
    id: 'technocracy',
    name: 'Technocracy',
    tagline: 'Admin OS & Telemetry · Permanent Dark Mode · Web',
    accentColor: '#00dc82',
    core: [
      {
        name: 'Primary (Emerald)',
        description: 'Emerald Green — Active indicators, live status pills, telemetry gauges, and primary actions.',
        root: '#00dc82',
        stops: [
          { stop: 25, hex: '#e6fbf2', textColor: '#0F172A' },
          { stop: 50, hex: '#bbf6de', textColor: '#0F172A' },
          { stop: 75, hex: '#87efc6', textColor: '#0F172A' },
          { stop: 100, hex: '#4ce3a8', textColor: '#0F172A' },
          { stop: 200, hex: '#1ad590', textColor: '#0F172A' },
          { stop: 300, hex: '#00dc82', textColor: '#02130d' },
          { stop: 400, hex: '#00c071', textColor: '#02130d' },
          { stop: 500, hex: '#00a360', textColor: '#fff' },
          { stop: 600, hex: '#00844e', textColor: '#fff' },
          { stop: 700, hex: '#00673d', textColor: '#fff' },
          { stop: 800, hex: '#004c2d', textColor: '#fff' },
          { stop: 900, hex: '#00331e', textColor: '#fff' },
          { stop: 925, hex: '#002616', textColor: '#fff' },
          { stop: 950, hex: '#00190e', textColor: '#fff' },
          { stop: 975, hex: '#000c07', textColor: '#fff' },
        ],
      ...
      {
        name: 'Brand Highlight (Crimson)',
        description: 'Crimson Red — Brand emblem, section crosshairs (✚), and critical system highlights.',
        root: '#e0575a',
        stops: [
          { stop: 25, hex: '#fcf0f0', textColor: '#0F172A' },
          { stop: 50, hex: '#f9d5d6', textColor: '#0F172A' },
          { stop: 75, hex: '#f4b3b5', textColor: '#0F172A' },
          { stop: 100, hex: '#ee8c8f', textColor: '#0F172A' },
          { stop: 200, hex: '#e76d71', textColor: '#0F172A' },
          { stop: 300, hex: '#e0575a', textColor: '#fff' },
          { stop: 400, hex: '#c93f42', textColor: '#fff' },
          { stop: 500, hex: '#ab2f32', textColor: '#fff' },
          { stop: 600, hex: '#8e2326', textColor: '#fff' },
          { stop: 700, hex: '#70191c', textColor: '#fff' },
          { stop: 800, hex: '#521012', textColor: '#fff' },
          { stop: 900, hex: '#37090b', textColor: '#fff' },
          { stop: 925, hex: '#290607', textColor: '#fff' },
          { stop: 950, hex: '#1c0304', textColor: '#fff' },
          { stop: 975, hex: '#0e0102', textColor: '#fff' },
        ],
        tokenPath: 'thcy.color.brand',
        cssPrefix: '--thcy-color-brand',
        keyStops: [300, 100, 400],
      },
      {
        name: 'Obsidian Surface',
        description: 'Deep Dark Canvas — Dark background layers (#04060f), glass card fills, and bordered telemetry panels.',
        root: '#04060f',
        stops: [
          { stop: 25, hex: '#404454', textColor: '#fff' },
          { stop: 50, hex: '#323645', textColor: '#fff' },
          { stop: 75, hex: '#262a37', textColor: '#fff' },
          { stop: 100, hex: '#1c1f2b', textColor: '#fff' },
          { stop: 200, hex: '#141721', textColor: '#fff' },
          { stop: 300, hex: '#0e111a', textColor: '#fff' },
          { stop: 400, hex: '#0b0e18', textColor: '#fff' },
          { stop: 500, hex: '#04060f', textColor: '#fff' },
          { stop: 600, hex: '#03050c', textColor: '#fff' },
          { stop: 700, hex: '#020409', textColor: '#fff' },
          { stop: 800, hex: '#020307', textColor: '#fff' },
          { stop: 900, hex: '#010204', textColor: '#fff' },
          { stop: 925, hex: '#010103', textColor: '#fff' },
          { stop: 950, hex: '#000102', textColor: '#fff' },
          { stop: 975, hex: '#000001', textColor: '#fff' },
        ],
        tokenPath: 'thcy.color.background',
        cssPrefix: '--thcy-color-bg',
        keyStops: [500, 400, 800],
      },
    ],
    gradients: [
      { name: 'Telemetry Pulse', token: 'gradient.telemetry', stops: 'primary.300 → brand.300', usage: 'Status overlays, telemetry card highlights', gradient: 'linear-gradient(135deg, #00dc82 0%, #e0575a 100%)' },
      { name: 'Obsidian Glass', token: 'gradient.glass', stops: 'surface.400 → surface.500', usage: 'Glass card fills, panel backdrops', gradient: 'linear-gradient(180deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.02) 100%)' },
      { name: 'Abyss Rail', token: 'gradient.abyss', stops: 'background.500 → panel.400', usage: 'Sidebar rail background, dense dividers', gradient: 'linear-gradient(180deg, #04060f 0%, #0b0e18 100%)' },
    ],
  },
  {
    id: 'yakaizen',
    ...
    core: [
      {
        ...
        root: '#970103',
        stops: [
          { stop: 25, hex: '#FBF5F5', textColor: '#0F172A' },
          { stop: 50, hex: '#EACCCD', textColor: '#0F172A' },
          { stop: 75, hex: '#E2B8B8', textColor: '#0F172A' },
          { stop: 100, hex: '#DAA4A4', textColor: '#0F172A' },
          { stop: 200, hex: '#C97B7C', textColor: '#0F172A' },
          { stop: 300, hex: '#B85254', textColor: '#fff' },
          { stop: 400, hex: '#A82A2B', textColor: '#fff' },
          { stop: 500, hex: '#970103', textColor: '#fff' },
          { stop: 600, hex: '#830507', textColor: '#fff' },
          { stop: 700, hex: '#6F090C', textColor: '#fff' },
          { stop: 800, hex: '#5B0D10', textColor: '#fff' },
          { stop: 900, hex: '#461215', textColor: '#fff' },
          { stop: 925, hex: '#3C1417', textColor: '#fff' },
          { stop: 950, hex: '#321619', textColor: '#fff' },
          { stop: 975, hex: '#28181C', textColor: '#fff' },
        ],
        tokenPath: 'color.crimson',
        cssPrefix: '--color-crimson',
        keyStops: [500, 100, 700],
      },
      {
        name: 'Secondary',
        ...
        root: '#FDA581',
        stops: [
          { stop: 25, hex: '#FFF4F0', textColor: '#0F172A' },
          { stop: 50, hex: '#FFEDE6', textColor: '#0F172A' },
          { stop: 75, hex: '#FEE6DC', textColor: '#0F172A' },
          { stop: 100, hex: '#FEDFD2', textColor: '#0F172A' },
          { stop: 200, hex: '#FED0BD', textColor: '#0F172A' },
          { stop: 300, hex: '#FEC2A9', textColor: '#0F172A' },
          { stop: 400, hex: '#FDB395', textColor: '#0F172A' },
          { stop: 500, hex: '#FDA581', textColor: '#0F172A' },
          { stop: 600, hex: '#D98F71', textColor: '#0F172A' },
          { stop: 700, hex: '#B47962', textColor: '#0F172A' },
          { stop: 800, hex: '#906352', textColor: '#fff' },
          { stop: 900, hex: '#6B4D42', textColor: '#fff' },
          { stop: 925, hex: '#59423A', textColor: '#fff' },
          { stop: 950, hex: '#473733', textColor: '#fff' },
          { stop: 975, hex: '#342C2B', textColor: '#fff' },
        ],
        tokenPath: 'color.peach',
        cssPrefix: '--color-peach',
        keyStops: [500, 200, 600],
      },
      {
        name: 'Tertiary',
        ...
        root: '#37415C',
        stops: [
          { stop: 25, hex: '#E7E8EB', textColor: '#0F172A' },
          { stop: 50, hex: '#D7D9DE', textColor: '#0F172A' },
          { stop: 75, hex: '#C7CAD1', textColor: '#0F172A' },
          { stop: 100, hex: '#B7BBC4', textColor: '#0F172A' },
          { stop: 200, hex: '#979CAA', textColor: '#0F172A' },
          { stop: 300, hex: '#777E90', textColor: '#0F172A' },
          { stop: 400, hex: '#575F76', textColor: '#fff' },
          { stop: 500, hex: '#37415C', textColor: '#fff' },
          { stop: 600, hex: '#323B52', textColor: '#fff' },
          { stop: 700, hex: '#2D3548', textColor: '#fff' },
          { stop: 800, hex: '#292F3F', textColor: '#fff' },
          { stop: 900, hex: '#242935', textColor: '#fff' },
          { stop: 925, hex: '#212630', textColor: '#fff' },
          { stop: 950, hex: '#1F232B', textColor: '#fff' },
          { stop: 975, hex: '#1D2026', textColor: '#fff' },
        ],
        tokenPath: 'color.navy',
        cssPrefix: '--color-navy',
        keyStops: [500, 100, 700],
      },
      {
        name: 'Positive',
        description: 'Kaayo Green — Attendance marked, payment received, class confirmed. Kaayo-only; does not use the shared feedback ramp.',
        root: '#01971A',
        stops: [
          { stop: 25, hex: '#E1F3E4', textColor: '#0F172A' },
          { stop: 50, hex: '#CCEAD1', textColor: '#0F172A' },
          { stop: 75, hex: '#B8E2BF', textColor: '#0F172A' },
          { stop: 100, hex: '#A4DAAD', textColor: '#0F172A' },
          { stop: 200, hex: '#7BC988', textColor: '#0F172A' },
          { stop: 300, hex: '#52B863', textColor: '#0F172A' },
          { stop: 400, hex: '#2AA83F', textColor: '#0F172A' },
          { stop: 500, hex: '#01971A', textColor: '#0F172A' },
          { stop: 600, hex: '#05831B', textColor: '#fff' },
          { stop: 700, hex: '#096F1C', textColor: '#fff' },
          { stop: 800, hex: '#0D5B1C', textColor: '#fff' },
          { stop: 900, hex: '#10481D', textColor: '#fff' },
          { stop: 925, hex: '#123E1E', textColor: '#fff' },
          { stop: 950, hex: '#14341E', textColor: '#fff' },
          { stop: 975, hex: '#162A1E', textColor: '#fff' },
        ],
        tokenPath: 'kayo.palette.positive',
        cssPrefix: '--kayo-palette-positive',
        keyStops: [500, 100, 700],
      },
      {
        name: 'Alert',
        description: 'Kaayo Alert — Dues approaching, schedule clash, action needed. Kaayo-only; Figma names this Alert, the semantic token is warning.',
        root: '#F5590B',
        stops: [
          { stop: 25, hex: '#FEEBE2', textColor: '#0F172A' },
          { stop: 50, hex: '#FDDECE', textColor: '#0F172A' },
          { stop: 75, hex: '#FCD1BB', textColor: '#0F172A' },
          { stop: 100, hex: '#FBC3A7', textColor: '#0F172A' },
          { stop: 200, hex: '#FAA980', textColor: '#0F172A' },
          { stop: 300, hex: '#F88E59', textColor: '#0F172A' },
          { stop: 400, hex: '#F77432', textColor: '#0F172A' },
          { stop: 500, hex: '#F5590B', textColor: '#0F172A' },
          { stop: 600, hex: '#D24F0E', textColor: '#fff' },
          { stop: 700, hex: '#AF4511', textColor: '#fff' },
          { stop: 800, hex: '#8B3B15', textColor: '#fff' },
          { stop: 900, hex: '#683118', textColor: '#fff' },
          { stop: 925, hex: '#572C19', textColor: '#fff' },
          { stop: 950, hex: '#45271B', textColor: '#fff' },
          { stop: 975, hex: '#33221D', textColor: '#fff' },
        ],
        tokenPath: 'kayo.palette.alert',
        cssPrefix: '--kayo-palette-alert',
        keyStops: [500, 100, 700],
      },
      {
        name: 'Negative',
        description: 'Kaayo Red — Cancelled class, failed payment, destructive actions. Shares 500 with the family ramp but carries Kaayo tint through the tails.',
        root: '#DC2626',
        stops: [
          { stop: 25, hex: '#FBE5E5', textColor: '#0F172A' },
          { stop: 50, hex: '#F8D4D4', textColor: '#0F172A' },
          { stop: 75, hex: '#F5C2C2', textColor: '#0F172A' },
          { stop: 100, hex: '#F2B1B1', textColor: '#0F172A' },
          { stop: 200, hex: '#ED8E8E', textColor: '#0F172A' },
          { stop: 300, hex: '#E76B6B', textColor: '#0F172A' },
          { stop: 400, hex: '#E24949', textColor: '#0F172A' },
          ...
          { stop: 800, hex: '#7E2123', textColor: '#fff' },
          { stop: 900, hex: '#5F1F22', textColor: '#fff' },
          { stop: 925, hex: '#501E21', textColor: '#fff' },
          { stop: 950, hex: '#401D20', textColor: '#fff' },
          { stop: 975, hex: '#301C20', textColor: '#fff' },
        ],
        tokenPath: 'kayo.palette.negative',
        cssPrefix: '--kayo-palette-negative',
        keyStops: [500, 100, 700],
      },
      {
        name: 'Supportive',
        description: 'Supportive Blue — Informational surfaces, links, and secondary guidance. Kaayo-only; verified against the product with the team.',
        root: '#266FDC',
        stops: [
          { stop: 25, hex: '#E5EEFB', textColor: '#0F172A' },
          { stop: 50, hex: '#D4E2F8', textColor: '#0F172A' },
