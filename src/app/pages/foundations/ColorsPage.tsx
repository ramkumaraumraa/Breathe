...
const brandPalettes: BrandPalette[] = [
  ...
  },
  {
    ...
    core: [
      ...
      {
        name: 'Tertiary',
        description: 'Sky — digital clarity, supporting accent. amra.color.tertiary resolves here via status.info.',
        root: '#40AAD4',
        stops: [
          { stop: 25, hex: '#EBF7FB', textColor: '#0F172A' },
          { stop: 50, hex: '#D9EEF6', textColor: '#0F172A' },
          ...
          { stop: 400, hex: '#5FB8DB', textColor: '#0F172A' },
          { stop: 500, hex: '#40AAD4', textColor: '#0F172A' },
          { stop: 600, hex: '#3A93B7', textColor: '#0F172A' },
          { stop: 700, hex: '#347C9A', textColor: '#fff' },
          { stop: 800, hex: '#2D657D', textColor: '#fff' },
          { stop: 900, hex: '#274E60', textColor: '#fff' },
          { stop: 925, hex: '#1E3D4C', textColor: '#fff' },
    ...
    gradients: [
      ...
      { name: 'Momentum', token: 'gradient.momentum', stops: 'primary.500 → tertiary.500', usage: 'Feature callouts, CTAs', gradient: 'linear-gradient(135deg, #2F9E44 0%, #40AAD4 100%)' },
      { name: 'Clarity', token: 'gradient.clarity', stops: 'secondary.500 → tertiary.500', usage: 'Service cards, portfolio highlights', gradient: 'linear-gradient(135deg, #CFCF2A 0%, #40AAD4 100%)' },
  ...
  },
  {
    ...
    core: [
      ...
      },
      {
        ...
        tokenPath: 'kayo.palette.supportive',
        cssPrefix: '--kayo-palette-supportive',
        keyStops: [500, 100, 700],
      },
    ],
    gradients: [
