...
const products: Product[] = [
  ...
  },
  {
    ...
    label: 'Technocracy',
    prefix: 'thcy',
    description: 'Permanent-dark admin telemetry surface. Obsidian glass, monospace, four signal colours.',
    surface: 'dark',
    platforms: ['Web CSS'],
    colors: [
      { name: 'Primary',               token: '--thcy-color-primary',                value: '#00dc82',                       role: 'Active indicator, primary CTA — Aumraa green, dark-vibrant' },
      { name: 'Primary Light',         token: '--thcy-color-primary-light',          value: 'rgba(0, 220, 130, 0.15)',       role: 'Tint for active fills' },
      { name: 'Primary Subtle',        token: '--thcy-color-primary-subtle',         value: 'rgba(0, 220, 130, 0.08)',       role: 'Active nav row background' },
      { name: 'Brand (slot)',          token: '--thcy-color-brand',                  value: '#e0575a',                       role: 'Observed product colour, dark-adapted — logo moments only, never data' },
      { name: 'Background',            token: '--thcy-color-background',             value: '#04060f',                       role: 'Obsidian — deepest dashboard surface' },
      { name: 'Background Secondary',  token: '--thcy-color-background-secondary',   value: '#0b0e18',                       role: 'Panel and modal surface' },
      { name: 'Glass',                 token: '--thcy-color-glass',                  value: 'rgba(255, 255, 255, 0.04)',     role: 'Glass card fill' },
      { name: 'Sidebar',               token: '--thcy-color-sidebar',                value: 'rgba(4, 6, 15, 0.72)',          role: 'Glass navigation rail' },
      { name: 'Foreground',            token: '--thcy-color-foreground',             value: '#f2f5fa',                       role: 'Primary text' },
      { name: 'Foreground Secondary',  token: '--thcy-color-foreground-secondary',   value: '#8b94a7',                       role: 'Labels, metadata' },
      { name: 'Foreground Tertiary',   token: '--thcy-color-foreground-tertiary',    value: '#596174',                       role: 'Disabled / future destinations' },
      { name: 'Border',                token: '--thcy-color-border',                 value: 'rgba(255, 255, 255, 0.11)',     role: 'Hairline dividers' },
      { name: 'Border Strong',         token: '--thcy-color-border-strong',          value: 'rgba(255, 255, 255, 0.22)',     role: 'Card corner marks, emphasis' },
      { name: 'Signal Green',          token: '--thcy-color-signal-green',           value: '#00dc82',                       role: 'Healthy — twin of feedback.positive' },
      { name: 'Signal Amber',          token: '--thcy-color-signal-amber',           value: '#f0a30a',                       role: 'Attention — twin of feedback.warning' },
      { name: 'Signal Red',            token: '--thcy-color-signal-red',             value: '#ff4444',                       role: 'Critical — twin of feedback.negative' },
      { name: 'Signal Blue',           token: '--thcy-color-signal-blue',            value: '#4da6ff',                       role: 'Informational — twin of feedback.supportive' },
      { name: 'Signal Muted',          token: '--thcy-color-signal-muted',           value: '#8b94a7',                       role: 'No signal / inactive' },
    ],
    typography: [
      { name: 'Family', token: '--thcy-font-family', value: 'Source Code Pro' },
      { name: 'Base size', token: '--thcy-font-size-base', value: '14px' },
      { name: 'Body weight', token: '--thcy-font-weight-body', value: '400' },
      { name: 'Heading weight', token: '--thcy-font-weight-heading', value: '700' },
    ],
    radius: [
      { name: 'Default', token: '--thcy-radius-default', value: '16px' },
      { name: 'Small', token: '--thcy-radius-sm', value: '8px' },
      { name: 'Large', token: '--thcy-radius-lg', value: '16px' },
    ],
    icons: [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Supportive',     token: '--amra-color-supportive',     value: '#266FDC', role: 'Informational accent, links — feedback family, not brand' },
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Supportive', token: '--ykai-color-supportive', value: '#266FDC', role: 'Informational accent — feedback family, not brand' },
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Tertiary',             token: '--mlgm-color-tertiary',             value: '#845E41', role: 'Earth Brown — grounding tone' },
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Positive',             token: '--kayo-color-positive',             value: '#01971A', role: 'Success, paid states — Kaayo bespoke green' },
      { name: 'Supportive',           token: '--kayo-color-supportive',           value: '#266FDC', role: 'Informational accent, links' },
      { name: 'Negative',             token: '--kayo-color-negative',             value: '#A81818', role: 'Errors, overdue, destructive' },
      { name: 'Warning',              token: '--kayo-color-warning',              value: '#F5590B', role: 'Partial payment, pending — Figma calls this Alert' },
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Supportive',           token: '--ilkh-color-supportive',           value: '#266FDC', role: 'Informational accent — feedback family, not brand' },
