...
export function BottomNavPage() {
  ...
  const wrapFrame = (child: React.ReactNode, variant: 'mobile' | 'tablet' = 'mobile') => {
    if (variant === 'tablet') {
      return (
        <AndroidFrame width={480} height={160} screenBg="#f8fafc">
          <div style={{ flex: 1 }} />
          {child}
        </AndroidFrame>
      )
    ...
    return (
      <AndroidFrame width={320} height={140} screenBg="#f8fafc">
        <div style={{ flex: 1 }} />
        {child}
      </AndroidFrame>
    )
          ...
          preview: isKaayo ? wrapFrame(
            <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
              <div style={{
                ...
                Active: <strong style={{ color: '#970103', marginLeft: 4 }}>{active}</strong>
              </div>
              <KayoBrutalistBottomNav
                variant="mobile"
                activeKey={active}
