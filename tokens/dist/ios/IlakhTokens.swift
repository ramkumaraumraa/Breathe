...
public class IlakhTokens {
    ...
    public static let ilkhColorBackgroundTertiary = UIColor(red: 0.953, green: 0.957, blue: 0.965, alpha: 1)
    public static let ilkhColorBorder = UIColor(red: 0.898, green: 0.906, blue: 0.922, alpha: 1)
    public static let ilkhColorBorderHover = UIColor(red: 0.820, green: 0.835, blue: 0.859, alpha: 1)
    public static let ilkhColorDanger = UIColor(red: 0.882, green: 0.114, blue: 0.165, alpha: 1)
    public static let ilkhColorForeground = UIColor(red: 0.122, green: 0.161, blue: 0.216, alpha: 1)
