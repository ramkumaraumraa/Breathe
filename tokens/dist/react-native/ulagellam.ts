...
export const UlgeSpacingPagePadding = 16;
export const UlgeSpacingCardPadding = 16;
export const UlgeSpacingSectionGap = 24;
export const UlgeRadiusDefault = 16;
export const UlgeRadiusSm = 8;
export const UlgeRadiusPill = 9999;
export const UlgeShadowCard =
  "0 1px 3px rgba(0,0,0,0.10), 0 1px 2px rgba(0,0,0,0.06)";
export const UlgeShadowModal =
  "0 10px 15px rgba(0,0,0,0.10), 0 4px 6px rgba(0,0,0,0.05)";
export const UlgeIconSm = 16;
export const UlgeIconMd = 20;
export const UlgeIconLg = 24;
